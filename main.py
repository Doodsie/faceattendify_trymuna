...
# Create a new table for image data
mycursor.execute("""
...
def generate_dataset(nbr):
    ...
    # This is the modified part to use Flask's Response for streaming
    return Response(generate_frames(), mimetype='multipart/x-mixed-replace; boundary=frame1')
